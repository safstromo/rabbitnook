...
fn main() -> Result<()> {
    ...
    view! {
            ...
            <div class="flex flex-col min-h-screen w-full bg-base items-start justify-center">
                ...
                <p>
                    Im writing this blog post because i had a hard time finding examples and guides on the subject and to share my experience and to help others save time and avoid some of the pitfalls I encountered.</p>
                  <p>  Since is the first time I am writing embedded code and I am still learning, if you see any mistakes or have any suggestions please let me know.
                    "😊"
                </p>

                <h2 class="my-6">Hardware</h2>
                <a
                    class="hover:text-maroon underline" target="_blank"
                ...
                <p>
                    ...
                    I had not defined the correct permissions in the policy and the ESP32 could not connect to the AWS IoT endpoint. I had a hard time figuring out what was wrong and the log message from the ESP32 was not very helpful and the logs in AWS IoT did not give me any clues either.</p><p> This is the log from the ESP32:
                </p>
                ...
                <p>
                    ...
                    <a class="underline hover:text-maroon" href="https://github.com/esp-rs/esp-idf-template">here.</a>
                    ...
                    <a class="underline hover:text-maroon" href="https://docs.esp-rs.org/std-training/">ESP STD Embedded Training</a>
                </p>
                ...
                Converting the certificates to the correct format was someting i struggled with. I found a solution that works but I am not sure if it is the best way to do it. If you know a better way please let me know. Here is a link to the stackoverflow thread where I found the solution: "
                    <a class="underline hover:text-maroon" href="https://stackoverflow.com/questions/75299434/rust-on-esp32-how-to-send-and-receive-data-using-the-mqtt-protocol-to-aws-io">link</a>
                </p>
